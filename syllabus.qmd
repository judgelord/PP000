...
<!--
- [📅 Sign up for discussion opening, closing remarks, and paper meetings]()
--> 

---

🚧 Syllabus updated: [`r Sys.Date() |> format("%B %d %Y")`](https://github.com/judgelord/PP000/commits/main/docs/syllabus.html). The current version is [here](syllabus.html). 🚧
