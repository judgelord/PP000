...
Otherwise, writing math in [MathJax](https://docs.mathjax.org/en/latest/basic/accessibility.html) is similar to LaTeX.
...
*TODO:* Use descriptive alt text for equations by including `\label{}` or `\tag{}`.
