...
**Instructor Contact Information and any instructions regarding communication**

**Instructor Office Hours (We ask our teaching faculty to offer at least two hours a week of office hours. Office hours can be held in-person and/or via Zoom and faculty can specify fixed days/times when they are available every week or use the google calendar appointment schedules feature if the timing differs week-to-week. Some faculty also communicate that they may be able to meet at other times and that students should email them to schedule those appointments. Finally, office hours can be structured as drop-in times when more than one student can join, or they can be one-on-one sessions for specific time slots.)**

**GSI Contact Information and Office Hours (if applicable)**	
...
**NOTE: Please pay close attention to whose writing, research, voice and opinions you include in your assigned readings/other material and guest speakers. We encourage assigning course materials that represent a range of perspectives and opinions.**

**Ford School Inclusivity Statement:** Members of the Ford School community represent a rich variety of backgrounds and perspectives. We are committed to providing an atmosphere for learning that respects these differences. While working together to build this community we ask all members to:
...
**Student Mental Health and Wellbeing:** The University of Michigan is committed to advancing the mental health and wellbeing of its students. We acknowledge that a variety of issues can directly impact students’ academic performance and overall wellbeing. If you or someone you know is feeling overwhelmed, depressed, and/or in need of support, services are available. 

You may access the Ford School’s embedded counselor Paige Ziegler (pziegler@umich.edu) and/or counselors and urgent services at [Counseling and Psychological Services](https://caps.umich.edu/) (CAPS) and/or [University Health Service](https://uhs.umich.edu/) (UHS). Students may also use the Crisis Text Line (text '4UMICH' to 741741) to be connected to a trained crisis volunteer.  

**Accommodations for Students with Disabilities:** The University of Michigan is committed to creating as accessible educational environment for students with disabilities as possible.   
If you anticipate or are experiencing barriers based on disability or temporary injuries, Services for Students with Disabilities (SSD) ([ssd.umich.edu](http://ssd.umich.edu)) is the office that students work with to explore reasonable accommodations, tools, and resources.  
...
**Use of Generative AI:** The Ford School does not have a policy regulating students’ usage of generative AI tools. We encourage you to set expectations and rules that make the most sense for your course and include a statement here. You can find several [example syllabi statements and resources on this site](https://genai.umich.edu/resources/faculty/course-policies) to help navigate what might work best in your course, including statements on (1) AI use-permitted, (2) AI use-permitted depending on activity type, and (3) AI use-forbidden.  
